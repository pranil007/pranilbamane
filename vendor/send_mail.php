...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
      ...
      $smtp_username    = 'wishbyaartikanani@gmail.com';             // SMTP username
      $smtp_password    = 'nndv fegx ppda tjpi';                         // SMTP password
      ...
      try {
         ...
         $mail->addAddress("pranil@innois.in", 'Wish Student Accommodation');                  // Enter the email address you want to send here
